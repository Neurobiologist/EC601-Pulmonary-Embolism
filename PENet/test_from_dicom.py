...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_study", type=str, default="/projectnb/ece601/kaggle-pulmonary-embolism/rsna-str-pulmonary-embolism-detection/test/00268ff88746/75d23269adbd")
    parser.add_argument("--series_description", type=str, default="CTPA")
    parser.add_argument("--ckpt_path", type=str, default="/projectnb/ece601/kaggle-pulmonary-embolism/meganmp/ckpts/penet_best.pth.tar")
